...
#' @export
ds.glmeSLMA.o<-function(formula=NULL, family=NULL, offset=NULL, weights=NULL, combine.with.metafor=TRUE,dataName=NULL,
  ...
  cally2 <- call('glmeSLMADS2.o', formula, family, offset, weights, dataName)
